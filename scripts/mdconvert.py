# This is copied from Magentic-one's great repo: 
...
class YouTubeConverter(DocumentConverter):
    ...
    def convert(self, local_path: str, **kwargs: Any) -> Union[None, DocumentConverterResult]:
        ...
        # We can also try to read the full description.
        # This is more prone to breaking, since it reaches into the page implementation
        try:
...
class PdfConverter(DocumentConverter):
    ...
    Most style information is ignored, so the results are essentially plain-text.
    """
...
class DocxConverter(HtmlConverter):
    ...
    Style information (e.g.m headings) and tables are preserved where possible.
    """
...
class ImageConverter(MediaConverter):
    ...
    OCR (if `easyocr` is installed), and description via a multimodal LLM (if an mlm_client is configured).
    """
...
class MarkdownConverter:
    ...
    def _guess_ext_magic(self, path):
        # """Guess a file's extension based on the first few bytes."""
